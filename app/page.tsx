...
export default function Portfolio() {
  ...
  const skills = {
    tools: ["Microsoft Office", "Microsoft Team", "Github", "MySQL", "Visual Studio Code",  "Figma", "Notion"], 
    hardSkills: [
      "Microsoft Exel",
      "Microsoft Word",
      "Microsoft PowerPoint",
      "Bahasa Pemograman dan Framework (PHP, Laravel, JavaScript, Node.js, Python, Express.jd, Bootstrap)",
      "Database Management (MySQL, PostgreSQL, SQL)",
      "Version Control (Git, Github)",
      "Tools (VScode, Figma, Notion, XAMPP"
     
    ],
    softSkills: ["Komunikasi", "Team Work", "Problem Solving", "Inisiatif", "Adaptif", "Time Management"],
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="animate-fade-in-up">
            ...
            >
              Information Systems Graduate || Front-End Development || Data Analyst
            </p>
            <p
              className="text-lg text-gray-500 mb-12 max-w-2xl mx-auto animate-slide-up"
              style={{ animationDelay: "0.6s" }}
            >
              Transforming Data into Decisions, Code into Experience.
            </p>
            <div
              ...
              <Card className="p-8 shadow-lg border-0 bg-gradient-to-br from-emerald-50 to-teal-50 hover:from-emerald-100 hover:to-teal-100 transition-all duration-500">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg hover:text-gray-900 transition-colors duration-300">
                    Lulusan Sistem Informasi dengan fokus pada pengembangan aplikasi web berbasis Laravel, JavaScript, dan teknologi fullstack. Memiliki pengalaman dalam membangun sistem informasi dan aplikasi web menggunakan berbagai bahasa pemrograman serta mengelola database relasional.
                  </p>
                  <p className="text-gray-700 leading-relaxed text-lg mt-4 hover:text-gray-900 transition-colors duration-300">
                    Terbiasa bekerja dalam tim, menyusun dokumentasi teknis, dan memiliki semangat tinggi dalam belajar teknologi baru. Siap mendukung pengembangan sistem informasi melalui solusi digital yang efisien dan inovatif.
                  </p>
                </CardContent>
              </Card>
            </AnimatedSection>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="group hover:bg-emerald-50 p-4 rounded-lg transition-all duration-300">
                    ...
                    <p className="text-gray-600 group-hover:text-gray-800">3.46/4.00</p>
                    <p>Tugas Akhir: Sistem Informasi Pembayaran Online berbasis Laravel dengan integrasi API QRIS.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                company: "Studi Independen MSIB Kampus Merdeka x Revou, Medan",
